...
MPU6050_Result MPU6050_ReadGyroscope(I2C_HandleTypeDef* I2Cx,MPU6050* DataStruct)
{
	...
	/* Format */
	DataStruct->Gyroscope_X = (int16_t)(data[0] << 8 | data[1])*(DataStruct->Gyro_Mult);
	DataStruct->Gyroscope_Y = (int16_t)(data[2] << 8 | data[3])*(DataStruct->Gyro_Mult);
	DataStruct->Gyroscope_Z = (int16_t)(data[4] << 8 | data[5])*(DataStruct->Gyro_Mult);
